class Keys:
    ...
    ROW_PROBABILITY_IN_HOUSEHOLDS_18_TO_23 = "row_probability_in_households_18_to_23"
    ROW_PROBABILITY_IN_GROUP_QUARTERS_UNDER_24 = "row_probability_in_group_quarters_under_24"

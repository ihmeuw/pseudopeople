...
pseudopeople is a Python package that generates realistic simulated data about a
fictional United States population, for use in testing entity resolution methods
or other data science algorithms. The fictional population was generated by
stochastically simulating multiple decades of population dynamics such as
fertility, mortality, migration and employment. pseudopeople builds on this
population by simulating errors in the data collection process to create
